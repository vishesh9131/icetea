...
class Settings(BaseSettings):
    ...
    # Per-LLM-call timeout. The OpenAI SDK defaults to 600s which lets a
    # hung self-hosted backend silently stall a multi-agent supervisor turn
    # for ten minutes. Bound it tightly here.
    llm_per_call_timeout_s: float = Field(default=60.0, ge=5.0, validation_alias="LLM_PER_CALL_TIMEOUT_S")
