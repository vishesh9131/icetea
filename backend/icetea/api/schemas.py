...
class ChatRequest(BaseModel):
    ...
    # If set, bypass the intent classifier and dispatch directly to this agent
    # name. Mainly used by the in-UI Agent Builder so the operator can run a
    # newly-defined custom agent without retraining the classifier.
