...
from icetea.api.app import create_app
from icetea.api import routes as routes_mod
...
def test_pipeline_reroutes_chat_recap_from_customer_support(monkeypatch, fake_llm):
    ...
    from icetea import pipeline as pipeline_mod
    from icetea.classifier import Classification, classify as real_classify
