...
> Findings, failures, iterations, and the multi-agent evolution that shaped
> the pipeline. This is the engineering log; see the repo-root `README.md`
> for the monorepo overview and quick-start.
